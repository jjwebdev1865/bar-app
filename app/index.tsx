...
import { mockGroups } from '../src/data/groups';
...
export default function HomeScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <Text style={[styles.title, { color: colors.accent }]}>{t('appName')}</Text>
                ...
                {selectedGroup.contacts.map((contact, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text style={[styles.memberStatus, { color: colors.accent }]}>
                        {t('onTheWay')}
                      </Text>
                    </View>
                  );
        ...
        <View style={[styles.modalBackdrop, { backgroundColor: colors.overlay }]}>
          ...
          >
            ...
            <View style={styles.modalActions}>
              ...
              >
                <Text style={[styles.modalButtonLabel, { color: colors.white }]}>
                  {t('stopSignal')}
                </Text>
              </Pressable>
            </View>
